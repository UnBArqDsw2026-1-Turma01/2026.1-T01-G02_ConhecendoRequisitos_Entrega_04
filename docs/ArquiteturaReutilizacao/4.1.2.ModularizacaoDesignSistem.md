...
Design Tokens são os átomos visuais de um design system. Eles substituem valores fixos (_hardcoded_) por variáveis semânticas. Por exemplo, em vez de repetir o valor hexadecimal `#9333ea` em múltiplos arquivos CSS, utilizamos a variável `--cr-purple-500` ou a variável semântica `--cr-brand`.
...
| 1.1    | 20/06/2026 | Adição do tópico Demonstração visual dos componentes | [Isabella Choukaira](https://github.com/isabellachoukaira) | [Arthur Evangelista](https://github.com/arthurevg)         | Revisado e aprovado |
